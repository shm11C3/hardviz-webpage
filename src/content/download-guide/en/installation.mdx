...
Install from the official channel for your operating system. If you are unsure about the source or file name, see [Installer verification](/verification/) before running the installer.

### Windows

#### Using the installer

1. Download `HardwareVisualizer_<version>_x64_en-US.msi` or `HardwareVisualizer_<version>_x64-setup.exe` from this page.
...
1. Download `HardwareVisualizer_<version>_amd64.deb` from this page.
...
1. Download `HardwareVisualizer-<version>-<release>.x86_64.rpm` from this page.
