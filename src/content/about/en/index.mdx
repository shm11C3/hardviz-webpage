...
| Backend | Tauri / Rust |
| Storage | DuckDB for new installs; existing SQLite history can be converted |

| OS | Hardware data sources |
| --- | --- |
| Common | sysinfo |
| Windows | WMI / PDH / NVAPI / ADL / DXGI / optional PawnIO |
...
| 2026.09 | Cooling Insight, DuckDB history for new installs, and optional PawnIO setup (v1.11.0) |
