...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 right-0 left-0 z-50 bg-gradient-to-b from-white/90 via-white/60 to-white/0 shadow-sm backdrop-blur-sm transition-all duration-300 dark:from-slate-900/90 dark:via-slate-900/60 dark:to-slate-900/0">
